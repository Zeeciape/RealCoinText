...
let firtPage_container=document.querySelector('.firtPage_container');
...
firtPage_container.style.height=`${screen.height-185}px`;
...
setInterval(()=>{
    if(sessionStorage.getItem('%width')===null || sessionStorage.getItem('%width') != screen.width || sessionStorage.getItem('%height') != screen.height){
        ...
        realCoins_mainContainer_home.style.height=`${screen.height-200-185}px`;
        realCoins_mainContainer_x2.style.height=`${screen.height-200-185}px`;
        realCoins_mainContainer_boost.style.height=`${screen.height-200-185}px`;
        realCoins_mainContainer_earn.style.height=`${screen.height-200-185}px`;
        realCoins_mainContainer_bobols.style.height=`${screen.height-200-185}px`;
        realCoins_mainContainer_dailyCipher.style.height=`${screen.height-200-185}px`;
